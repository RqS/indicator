...
def load_movement_matcher(nlp):
    ...
    matcher.add_pattern(1, [{LOWER: "leave"}, {IS_ASCII: True, 'OP': '+', ENT_TYPE: "DATE"}])
    matcher.add_pattern(1, [{LOWER: "leave"}, {DEP: "partmod"}])
    matcher.add_pattern(1, [{LOWER: "leave"}, {IS_ASCII: True}, {DEP: "partmod"}])
    matcher.add_pattern(1, [{LOWER: "leave"}, {DEP: "quantmod"}])
    matcher.add_pattern(1, [{LOWER: "leave"}, {IS_ASCII: True}, {DEP: "quantmod"}])
    matcher.add_pattern(1, [{LOWER: "leave"}, {IS_ASCII: True, 'OP': '+', ENT_TYPE: "TIME"}])
    matcher.add_pattern(1, [{LOWER: "leave"}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '+', ENT_TYPE: "DATE"}])
    ...
    matcher.add_pattern(1, [{LOWER: "town"}, {IS_ASCII: True}, {LOWER: "stay", DEP: "nmod"}])
    ...
    matcher.add_pattern(1, [{LOWER: "new", DEP: "amod"}, {IS_ASCII: True}, {LOWER: "city"}, {IS_ASCII: True}, {LOWER: "to", DEP: "dep"}])
    ...
    matcher.add_pattern(1, [{LOWER: "i", DEP: "nsubj"}, {IS_ASCII: True}, {LOWER: "arrive"}])
    matcher.add_pattern(1, [{LOWER: "i", DEP: "nsubj"}, {LOWER: "arrive"}])
    matcher.add_pattern(1, [{LOWER: "girl", DEP: "nsubj"}, {LOWER: "arrive"}, {DEP: "partmod"}])
    matcher.add_pattern(1, [{LOWER: "girl", DEP: "nsubj"}, {IS_ASCII: True}, {LOWER: "arrive"}, {IS_ASCII: True}, {DEP: "partmod"}])
    matcher.add_pattern(1, [{LOWER: "girl", DEP: "nsubj"}, {LOWER: "arrive"}, {DEP: "quantmod"}])
    matcher.add_pattern(1, [{LOWER: "girl", DEP: "nsubj"}, {IS_ASCII: True}, {LOWER: "arrive"}, {IS_ASCII: True}, {DEP: "quantmod"}])
    ...
    matcher.add_pattern(1, [{LOWER: "i", DEP: "nsubj"}, {IS_ASCII: True}, {LOWER: "visit"}, {IS_ASCII: True}, {is_place: True, DEP: "dobj"}])
    ...
    matcher.add_pattern(3, [{LOWER: "it", DEP: "dobj"}, {LOWER: "leave"}, {IS_ASCII: True, DEP: "nmod", TAG: "TO"}])
    matcher.add_pattern(3, [{LOWER: "that", DEP: "dobj"}, {LOWER: "leave"}, {IS_ASCII: True, DEP: "nmod", TAG: "TO"}])
    matcher.add_pattern(3, [{LOWER: "best"}, {LOWER: "move"}])
    matcher.add_pattern(3, [{LOWER: "next"}, {LOWER: "move"}])
    matcher.add_pattern(3, [{LOWER: "arrive"}, {IS_ASCII: True}, {IS_ASCII: True, DEP: "xcomp"}])
    matcher.add_pattern(3, [{LOWER: "arrive"}, {IS_ASCII: True, DEP: "xcomp"}])
    matcher.add_pattern(3, [{LOWER: "visit"}, {LOWER: "sister", DEP: "dobj"}])
    matcher.add_pattern(3, [{LOWER: "visit"}, {IS_ASCII: True}, {LOWER: "sister", DEP: "dobj"}])
    matcher.add_pattern(3, [{LOWER: "visit"}, {LOWER: "family", DEP: "dobj"}])
    matcher.add_pattern(3, [{LOWER: "visit"}, {IS_ASCII: True}, {LOWER: "family", DEP: "dobj"}])
    ...
    matcher.add_pattern(4, [{LOWER: "new"}, {LOWER: "backpage", DEP: "nmod", TAG: "TO"}])
    matcher.add_pattern(4, [{LOWER: "new"}, {IS_ASCII: True}, {LOWER: "backpage", DEP: "nmod", TAG: "TO"}])
    matcher.add_pattern(4, [{LOWER: "new"}, {LOWER: "bp", DEP: "nmod", TAG: "TO"}])
    matcher.add_pattern(4, [{LOWER: "new"}, {IS_ASCII: True}, {LOWER: "bp", DEP: "nmod", TAG: "TO"}])
    ...
    matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True}, {LOWER: "message", DEP: "dobj"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True}, {LOWER: "msg", DEP: "dobj"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True}, {LOWER: "txt", DEP: "dobj"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True}, {LOWER: "text", DEP: "dobj"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True}, {LOWER: "impression", DEP: "dobj"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True}, {LOWER: "voicemail", DEP: "dobj"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True}, {LOWER: "smile", DEP: "dobj"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {LOWER: "satisfied"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {LOWER: "memory", DEP: "dobj"}])
    matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True}, {LOWER: "memory", DEP: "dobj"}])
