...
total_data_f = open("/home/ubuntu/dig_indicator/data/outcall_data/outcall_experiment/dataset_experi2.txt", 'w')



data_neg_f = open('/home/ubuntu/dig_indicator/data/outcall_data/outcall_neg.txt', 'r')
data_neg_lst = []
k = 0
